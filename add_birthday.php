        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="glyphicon glyphicon-plus"></i> Add Birthday
                            </li>
                        </ol>
                    </div>
                </div>
				<?php if(isset($_POST['submit']))
				{
					...
					$qry="INSERT INTO special (userid,recipient,rec_no,date,day_type,message) VALUES ('$id','$name','$mob','$date','B','$message');";
