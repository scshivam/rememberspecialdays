...
<head>
    ...
    <title>Delete Special Day</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="glyphicon glyphicon-trash"></i> Delete Special Day
                            </li>
                        </ol>
                    </div>
                </div>
						...
						<form action="#" method="post">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
									...
									<?php $i=$_SESSION['id'];
									$msgid=$_POST['submit'];
									$query="DELETE from special where userid='$i' AND day_type='S' AND id='$msgid'";
