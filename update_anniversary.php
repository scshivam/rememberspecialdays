...
<head>
    ...
    <title>Update Anniversary</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="glyphicon glyphicon-pencil"></i> Update Anniversary
                            </li>
                        </ol>
                    </div>
                </div>
						...
						<form action="#" method="post" onsubmit="return validate();">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
									...
									<?php $i=$_SESSION['id'];
									$msgid=$_POST['submit'];
									$query="Select * from special where userid='$i' AND day_type='A' AND id='$msgid'";
