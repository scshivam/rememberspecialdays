                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="glyphicon glyphicon-th-list"></i> Upcoming Special Days
                            </li>
                        </ol>
                    </div>
                </div>
						...
						<form action="#" method="post">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
									...
									for($j=1;$j<8;$j++)
									{
									$tom=date('m-d',time()+($j*86400));
									$query="Select * from special where userid='$i' AND DATE_FORMAT(date,'%m-%d')='$tom'";
